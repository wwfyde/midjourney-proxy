...
namespace Midjourney.Infrastructure.Data
{
    ...
    public class DbHelper : SingletonBase<DbHelper>
    {
        ...
        private IDataHelper<OuterUser> _outerUserStore;
        private IDataHelper<Quota> _quotaStore;
                ...
                case DatabaseType.SQLServer:
                    {
                        ...
                        _outerUserStore = new FreeSqlRepository<OuterUser>();
                        _quotaStore = new FreeSqlRepository<Quota>();
                    }
                    break;
                default:
                    break;
